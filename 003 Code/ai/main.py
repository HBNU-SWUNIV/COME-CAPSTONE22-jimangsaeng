...
def enhance_img(img):
    en_img = image_enhance.image_enhance(img)
...
def pred(img1, img2):
    ...
    best_model = joblib.load('model/0629.pkl')
...
def main():
    ...
    print(res, end='')
    sys.stdout.flush()
    print('\nWorking time : {}'.format(time.time() - start_time))
